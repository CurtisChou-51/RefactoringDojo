namespace GildedRose.TestProject
{
    public class UnitTest2
    {
        ...
        {
            var normalItem1 = new BaseItem { Name = "+5 Dexterity Vest", SellIn = 10, Quality = 50 };
            var normalItem2 = new BaseItem { Name = "+5 Dexterity Vest", SellIn = 1, Quality = 50 };
            var conjuredItem1 = new Conjured { Name = "Conjured Mana Cake", SellIn = 10, Quality = 50 };
            var conjuredItem2 = new Conjured { Name = "Conjured Mana Cake", SellIn = 1, Quality = 50 };
            var conjuredItem3 = new Conjured { Name = "Conjured Mana Cake", SellIn = 10, Quality = 3 };
            List<BaseItem> items = [normalItem1, conjuredItem1, normalItem2, conjuredItem2, conjuredItem3];
            var app = new App(items);
